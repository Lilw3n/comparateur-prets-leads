...
//		check($data);die;
	...
	public function get_columns() {
		$columns = array(
			...
			'name'           => esc_html__( 'Coupon Code', 'woo-abandoned-cart-recovery' ),
			'number_of_used' => esc_html__( 'Number of Used', 'woo-abandoned-cart-recovery' ),
			'amount'         => esc_html__( 'Amount', 'woo-abandoned-cart-recovery' ),
			'type'           => esc_html__( 'Type', 'woo-abandoned-cart-recovery' ),
			'description'    => esc_html__( 'Description', 'woo-abandoned-cart-recovery' ),
		);
