...
//		check($data);die;
	...
	public function get_columns() {
		$columns = array(
//			'id'         => esc_html__( 'Product Id', 'woo-abandoned-cart-recovery' ),
			'name'       => esc_html__( 'Product Name', 'woo-abandoned-cart-recovery' ),
			'abd_qty'    => esc_html__( 'Current Abandoned', 'woo-abandoned-cart-recovery' ),
			'abd_amount' => esc_html__( 'Amount of Abandoned', 'woo-abandoned-cart-recovery' ),
			'rcv_qty'    => esc_html__( 'Recovered', 'woo-abandoned-cart-recovery' ),
			'rcv_amount' => esc_html__( 'Amount of Recovered', 'woo-abandoned-cart-recovery' ),
		);
